...
<?php
	...
	function new_header($name="Ahmed Moumad", $urlLink="") {
		echo "<head>";
		...
		echo "<li class='name'>";
		echo "  <h1 align='left'><a href='/~amoumad/".$urlLink."'>$name</a></h1>";
		echo "</li>";
		echo "</ul>";
		echo "</nav>";
		echo "</div>";	
	...
	function new_footer($name="Ahmed Moumad"){
		date_default_timezone_set("America/Chicago");
		echo "<br /><br /><br />";
	    echo "<h4><div class='text-center'><small>Copyright Ahmed Moumad and Albert Pham-Dao ".date("M Y").", ".$name."</small></div></h4>";
		echo "</body>";
		echo "</html>";
	}	
